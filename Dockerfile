...
# Copy core files
COPY src/core/particle_utils.py src/core/file_handler.py src/core/dependency_tracker.py src/core/utils.py src/core/file_utils.py src/core/particle_generator.py src/core/path_resolver.py src/core/cache_manager.py src/core/
